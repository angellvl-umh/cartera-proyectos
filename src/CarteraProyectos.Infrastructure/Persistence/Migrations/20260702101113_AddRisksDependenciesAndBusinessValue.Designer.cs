...
namespace CarteraProyectos.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260702101113_AddRisksDependenciesAndBusinessValue")]
    partial class AddRisksDependenciesAndBusinessValue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarteraProyectos.Core.Domain.ProjectDependency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CarteraProyectos.Core.Domain.Sprint", b =>
                {
                    ...
                    b.Property<int?>("DeliveredPoints")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CarteraProyectos.Core.Domain.ProjectDependency", b =>
                {
                    b.HasOne("CarteraProyectos.Core.Domain.Project", "DependsOnProject")
                        .WithMany()
            ...
            modelBuilder.Entity("CarteraProyectos.Core.Domain.ProjectRisk", b =>
                {
                    b.HasOne("CarteraProyectos.Core.Domain.Person", "CreatedBy")
                        .WithMany()
