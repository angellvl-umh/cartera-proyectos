...
Tu rol es implementar features en Angular 21 con signals, zoneless y NG-ZORRO. Antes de empezar, lee `.ai/skills/angular21/SKILL.md` para los patrones detallados.
