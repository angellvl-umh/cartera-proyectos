...
3. Genera la especificación con estas secciones:
   ...
   - **Permisos requeridos por rol** (valida contra la matriz de permisos del dominio en AGENTS.md)
...
- Valida SIEMPRE que la spec respeta las máquinas de estado de Project y WorkItem definidas en AGENTS.md
