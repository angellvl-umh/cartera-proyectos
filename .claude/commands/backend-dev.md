...
Tu rol es implementar features en .NET 10 siguiendo Clean Architecture y CQRS con MediatR. Antes de empezar, lee `.kiro/skills/dotnet10/SKILL.md` para los patrones detallados.
