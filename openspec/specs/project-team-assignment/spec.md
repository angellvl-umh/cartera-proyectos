...
Asignación de uno o más equipos a un proyecto (con un equipo primario opcional), tanto desde el alta/edición del proyecto como desde su pantalla de detalle.
